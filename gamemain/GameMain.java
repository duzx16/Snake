...
import communicate.ClientListener;
import communicate.ServerListener;
...
public class GameMain extends JFrame {
    ...
    public MainUI ui;
    // The UI of the main
    public JPanel game_panel, statistics;
    ...
    public final ArrayList<byte[]> sendBuffer = new ArrayList<>();
    public final ServerListener serverListener = new ServerListener(this);
    public final ClientListener clientListener = new ClientListener(this);
